...
all_cells_file="/Users/Henry Mackay/Desktop/layout/cell_src/1T1R_EBL_cells_ex.gds" #Gds containing all devices to be tiled as subcells
created_containing_cell_name="1T1R_EBL_placed_transistors" #Topcell name for output gds
output_file="/Users/Henry Mackay/Desktop/layout/1T1R_EBL_tiled_example.gds" #Output file path


########## Alignment Cross Parameters ##########
  
place_cross=True
marker_cell_file="/Users/Henry Mackay/Desktop/layout/Cross_1.gds" #File for alignement cross, lower left corner should be placed at the origin
marker_name="Cross"
num_markers=3
marker_coords_x = [0,10*1000,20*1000]
...
#length and width of transistor subcell in nm
y_pitch=68 * 1000 
x_pitch=280 * 1000
...
add_text=True
custom_font=False
font_file="/Users/Henry Mackay/Documents/1T1R_UPDATE/Large_Placement/block_via_font.gds"
